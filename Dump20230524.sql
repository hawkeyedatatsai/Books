...
CREATE TABLE `authos` (
  ...
  `author_name` text,
  KEY `ix_authos_index` (`index`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `authos`
--

LOCK TABLES `authos` WRITE;
/*!40000 ALTER TABLE `authos` DISABLE KEYS */;
INSERT INTO `authos` VALUES (0,1,'Stephen King'),(1,2,'F.Scott Fitgerald'),(2,3,'Jack London'),(3,4,'Jane Austen'),(4,5,'Mary Shelley');
/*!40000 ALTER TABLE `authos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-05-24 23:16:57
